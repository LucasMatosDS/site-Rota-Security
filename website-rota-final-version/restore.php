  ...
  <div id="cadastre_se" class="container texto cadastro m-20 col-md-4" style="padding-bottom: auto;">
    <div class="card-body">
     ...
     <form method="post" name="recBackup" action="./processa.php" enctype="multipart/form-data">
       ...
       <label>Usuario:</label>
       <input type="text" class="form-control mb-2" name="usuario_server" autocomplete="off" placeholder="Insira o usuário do BD" required>
       <label>Senha:</label>
       <input type="password" class="form-control mb-2" name="senha_server" autocomplete="off" placeholder="Insira senha (opcional)">
       <label>Base de Dados:</label>
       <input type="text" class="form-control mb-2"  name="db_name" autocomplete="off" placeholder="Insira o nome do BD" required>
       ...
       <button id="btn-limpar" type="reset" name="limpar" class="btn">Cancelar</button>
     </div>
     <?php
