...
<body class="animated fadeIn">
    ...
    <div class="card-body">
     ...
     <form method="POST" action="cadastro.php" name="dadosCadastro">
       <div class="form-group col-md-8">
          ...
          <input type="text" class="form-control" name="nome" autocomplete="off" placeholder="Informe seu Nome" onkeypress="return SomenteLetras(event)" required="true" maxlength="30"/>
       </div>
       <div class="form-group col-md-8">
          <label>E-mail:</label>
          <input type="email" class="form-control" name="emailC" autocomplete="off" placeholder="Informe seu E-mail" required="true" maxlength="30" />
       </div>
       <div class="form-group col-md-8">
           <label>CPF:</label>
           <input id="cpf" type="text" class="form-control mb-1" name="cpf" autocomplete="off" placeholder="Informe seu CPF" required="true"/>
          </div>
          <div class="form-group col-md-8">
            <label>Senha:</label>
 ...
 <?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Impossivél cadastrar usuário,<br>E-mail e/ou CPF já cadastrado no sistema!</strong>
        </div>
