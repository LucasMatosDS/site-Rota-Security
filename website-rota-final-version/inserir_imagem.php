  ...
  <div id="cadastre_se" class="container texto cadastro">
    <div class="card-body">
      ...
      <div class="card-title">
        ...
        <h3 id="titulo-login" align="center">inserir imagem</h3>
          </li>
          <hr>
        </div>
 ...
 <?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        if(isset($_FILES['foto'])){
             ...
             $img->imagem = sha1($_FILES['foto']['name']).rand(0,9999).".".pathinfo($_FILES['foto']['name'], PATHINFO_EXTENSION);
             move_uploaded_file($_FILES['foto']['tmp_name'], 'imagens/'.$img->imagem);
               ...
               <div class="alert alert-danger alert-dismissible" role="alert">
                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                   <strong>Erro ao inserir imagem!</strong>
               </div>
