        ...
        <?php
            ...
            foreach($dados_postagem as $conteudo){
                ...
                <div class="card mb-2" id="cont_post">
                  <div class="card-body">
                    <h4 style="font-weight: bold;"><?php echo $conteudo['titulo_postagem'];?></h4>
                    <hr>
                      <p style="text-align: justify;font-weight: bold;"><?php echo $conteudo['conteudo'];?></p>
                      <?php
                        $caminho = "imagens/";
                        if(is_dir($caminho)){
                         if(file_exists($caminho.$conteudo['imagem']) && $conteudo['imagem'] != "" && $conteudo['imagem'] != null){
                            ?>
                            <img src="imagens/<?php echo $conteudo['imagem'];?>" id="imagem2" class="img-thumbnail border rounded" alt="Imagem Indisponível">
                            <?php
                         }else{
                           ?>
                    ...
                    <a href="editar_postagem.php?id_post=<?php echo $conteudo['id_postagem']."&imagem=".$conteudo['imagem'];?>" class="btn btn-primary deletar mb-2"><img src="img/edite.png"  class="mr-2" width="25px">Editar</a>
                  </div>
                </div>
                <?php
          }
